...
/* Declare our new 32px Arabic font */
LV_FONT_DECLARE(lv_font_dejavu_32_persian_hebrew)

/* Declare KFGQPC Uthmanic Script font */
LV_FONT_DECLARE(lv_font_kfgqpc_uthmanic_32)
